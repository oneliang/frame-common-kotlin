...
object MySqlUtil {
    fun selectPaginationSql(table: String, condition: String = Constants.String.BLANK, sequenceKey: String, startSequence: String, orderBy: String, rowPerPage: Int): String {
